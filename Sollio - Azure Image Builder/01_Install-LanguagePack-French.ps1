...
.DESCRIPTION
   Le script tÈlÈcharger un zip avec les pack de langue Francais d'un blob storage Azure
.CREATOR
    Marc-AndrÈ Brochu | HelpOX | mabrochu@helpox.com | 514-666-4357 Ext:3511
.DATE
    20 Fevrier 2022
.VERSION
